...
parser.add_argument("--index_csv", type=str, default='/data/sls/scratch/yuangong/audioset/datafiles/class_labels_indices.csv', help="the root path of data json file")

if __name__ == '__main__':
    args = parser.parse_args()
    data_path = args.data_path

    index_dict = make_index_dict(args.index_csv)
